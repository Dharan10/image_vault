...
if __name__ == "__main__":
    ...
    operation = input("Do you want to encrypt or decrypt an image? (encrypt/decrypt): ").strip().lower()
    ...
    if operation == "encrypt":
        ...
        # Define output paths
        encrypted_image_path = image_name + ".bin"
        ...
        print(f"Key has been saved securely to the log file. And the key is {key.hex()}")
        ...
        if key:
            ...
            print("Specific key not found in the log. Please provide the key manually.")
            key_hex = input("Enter the 256-bit decryption key (hex): ").strip()
